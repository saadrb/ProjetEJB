...
<body>
	...
	<b> <s:form action="addArticle">
			<s:textfield name="designation" key="article.designation" value="" />
			...
			<s:select name="articleMarque" key="article.marque" value=""
				list="%{#{'marque1':'marque1','marque2':'marque2','marque3':'marque3','marque4':'marque4'}}" />
			<s:checkboxlist name="articleTypes" key="article.type" value=""
				list="{'Type1','Type2','Type3','Type4','Type5','Type6'}" />
			<s:submit key="submit.Ajouter" align="center" />
		</s:form>
	</b>
</body>
</html>